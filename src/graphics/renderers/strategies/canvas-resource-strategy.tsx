...
/** Resource strategy for canvas renderers. Creates a uniform buffer and a single render bind group with the uniform at binding 0. No compute resources needed. */
