...
/** Render strategy for particle renderers. Optionally renders a background pass (full-screen triangle, clears to black), then draws instanced particle geometry on top using loadOp 'load' to preserve the background. */
