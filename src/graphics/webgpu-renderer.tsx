...
/**
 * Particle Renderer using Strategy Pattern
 * Composes particle-specific strategies to handle particle simulation and rendering
 */
export class ParticleRenderer extends StrategyBasedRenderer {
    ...
    constructor(
        ...
        const updateStrategy = new ParticleComputeStrategy(computeConfig, resourceStrategy);
    ...
    async recompileShaders(
        ...
        if (options?.computeConfig) {
            ...
            this.updateStrategy = new ParticleComputeStrategy(
                this.computeConfig,
